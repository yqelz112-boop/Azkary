...
function updateHadithDisplay() {
    ...
    document.getElementById('hadithNarrator').textContent = hadith.narrator;
    document.getElementById('hadithSource').textContent = hadith.source;
    
    const likeBtn = document.getElementById('likeBtn');
    likeBtn.textContent = likedHadiths.includes(hadith.id) ? '❤️' : '🤍';
...
document.addEventListener('DOMContentLoaded', () => {
    initHadithCarousel();
    // initialize prayer widget (geolocation or manual city)
    initPrayerWidget();
